...
export const PAGES: Record<string, PageDef> = {
  ...
  therapies: page({
    ...
    eyebrow: "Wellness",
    summary:
      "More than fifty individual therapies — from Shirodhara and Abhyanga to Netra Tarpana and Elakizhi — each with its own indications, preparation and after-care.",
    hero: "spa",
    parent: { label: "Ayurveda Wellness Centre", href: "/ayurveda-wellness-centre" },
    sections: [
      {
        ...
        category: "spa",
        items: [
          { title: "Shirodhara", text: "A steady stream of warm medicated oil over the forehead to still the mind." },
          { title: "Abhyanga", text: "Full-body synchronised massage with dosha-specific herbal oils." },
          { title: "Pizhichil", text: "Warm oil bath — deeply nourishing for the nervous system and joints." },
          { title: "Kati Basti", text: "A warm oil pool held over the lower back for pain and stiffness." },
          { title: "Nasya", text: "Nasal administration of medicated oils for the head and sinuses." },
          { title: "Netra Tarpana", text: "Medicated ghee bath for the eyes — for strain and dryness." },
          { title: "Elakizhi", text: "Herbal-leaf poultice fomentation for musculoskeletal pain." },
          { title: "Udwarthanam", text: "Herbal-powder massage for metabolism and lymphatic flow." },
        ],
      },
      {
        kind: "intro",
        heading: "Every therapy page covers",
        body: [
          "Description and origin · benefits · contraindications · duration · assigned therapist · preparation · post-care · and direct booking. Individual therapy pages are published progressively.",
        ],
      },
      bookCta,
    ],
  ...
  "wellness-packages": page({
    ...
    eyebrow: "Wellness",
    summary:
      "Fixed-inclusion packages that bundle accommodation, therapies, consultations and meals into a single tariff.",
    hero: "meditation",
    sections: [
      {
        kind: "pricing",
        heading: "Sample packages",
        body: "Indicative per-person tariffs, twin-share. Final pricing depends on room category and season.",
        items: [
          { name: "Reset — 3 nights", price: "₹32,000", cadence: "from / person", features: ["Consultation & dosha analysis", "2 therapies daily", "Prescribed meals", "Daily yoga & meditation", "Forest Deluxe room"], href: "/book-now" },
          { name: "Renew — 7 nights", price: "₹86,000", cadence: "from / person", features: ["Everything in Reset", "Preparatory Panchakarma", "48-hour medical reviews", "Premium Cottage", "Take-home routine"], href: "/book-now", featured: true },
          { name: "Restore — 14 nights", price: "₹1,72,000", cadence: "from / person", features: ["Full classical Panchakarma", "Dedicated therapist", "Lake Cottage or Bamboo Villa", "Rasayana rebuilding phase", "Tele-follow-up x2"], href: "/book-now" },
        ],
      },
      bookCta,
    ],
  ...
  "luxury-stay": page({
    ...
    sections: [
      ...
      {
        kind: "features",
        heading: "In every category",
        items: [
          { title: "Private verandah", text: "Every unit opens to the outdoors." },
